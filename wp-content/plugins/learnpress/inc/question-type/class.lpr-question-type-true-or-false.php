	...
	function admin_interface( $args = array() ) {
		...
		<table class="lpr-sortable lpr-question-option">
			...
			<tr>
				...
				<td>
					<input class="lpr-answer-text" type="text" name="lpr_question[<?php echo $post_id; ?>][answer][text][__INDEX__0]" value="<?php echo esc_attr( $this->get( 'options.answer.0.text', __( 'True', 'learnpres' ) ) ); ?>" />
				</td>
			</tr>
			<tr>
				<td class="lpr-sortable-handle">
				...
				<td>
					<input class="lpr-answer-text" type="text" name="lpr_question[<?php echo $post_id; ?>][answer][text][__INDEX__1]" value="<?php echo esc_attr( $this->get( 'options.answer.1.text', __( 'False', 'learnpres' ) ) ); ?>" />
				</td>
			</tr>
			</tbody>
		</table>
