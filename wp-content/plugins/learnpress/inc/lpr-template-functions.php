...
function learn_press_after_question_content( $id ) {
	...
	if ( !empty( $hint ) ) :
		...
		<?php
		// @Tai Beo: This is entirely accurate when call this function if using global $post
		// but, if you call in this place that means if a question has not got the HINT so
		// this function is never called. While this function should be called if we
		// have used the $post and the data is modified
		// ---- Sorry my bad English :) ---
		// wp_reset_postdata();
	endif;
	// therefore, this is place where the function should be called
	wp_reset_postdata();
}
