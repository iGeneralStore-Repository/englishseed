 ...
 */
!function(s){"use strict";s.fn.cmsmastersResponsiveNav=function(n){var t={submenu:"ul.sub-menu",respButton:".responsive_nav",startWidth:checker.ua.safari&&!checker.ua.chrome?1024:1007},e=this,i={};i={init:function(){i.o=s.extend({},t,n),i.el=e,i.v={},i.v.pLinkText="",i.v.subLinkToggle=void 0,i.setVars(),i.restartNav()},setVars:function(){i.v.submenu=i.el.find(i.o.submenu),i.v.subLink=i.v.submenu.closest("li").find("> a"),i.v.respButton=s(i.o.respButton),i.v.startWidth=i.o.startWidth,i.v.win=s(window),i.v.trigger=!1,i.v.counter=0,i.startEvent()},buildNav:function(){i.v.trigger=!0,i.v.counter=1,i.v.subLink.each(function(){""===s(this).text()&&(i.v.pLinkText=s(this).closest("ul").closest("li").find("> a").text(),s(this).addClass("cmsmasters-resp-nav-custom-text").html("<span>"+i.v.counter+". "+i.v.pLinkText+"</span>"),i.v.counter+=1),s(this).append('<span class="cmsmasters_resp_nav_toggle cmsmasters-icon-angle-right" />')}),i.v.subLinkToggle=i.v.subLink.find("> span.cmsmasters_resp_nav_toggle"),i.v.submenu.hide(),i.attachEvents()},restartNav:function(){!i.v.trigger&&i.v.win.width()<=i.v.startWidth?i.buildNav():i.v.trigger&&i.v.win.width()>i.v.startWidth&&i.destroyNav()},resetNav:function(){i.v.subLinkToggle.removeClass("cmsmasters-icon-angle-up active").addClass("cmsmasters-icon-angle-right"),i.v.submenu.hide()},destroyNav:function(){i.v.subLink.each(function(){s(this).hasClass("cmsmasters-resp-nav-custom-text")&&s(this).removeClass("cmsmasters-resp-nav-custom-text").text(""),s(this).find("span.cmsmasters_resp_nav_toggle").remove()}),i.v.submenu.css("display",""),i.v.trigger=!1,i.detachEvents()},startEvent:function(){i.v.win.on("resize",function(){i.restartNav()})},attachEvents:function(){i.v.subLinkToggle.on("click",function(){return s(this).hasClass("cmsmasters-icon-angle-up active")?(s(this).removeClass("cmsmasters-icon-angle-up active").addClass("cmsmasters-icon-angle-right").closest("li").find("ul.sub-menu").hide(),s(this).closest("li").find("span.cmsmasters_resp_nav_toggle").removeClass("cmsmasters-icon-angle-up active").addClass("cmsmasters-icon-angle-right")):s(this).removeClass("cmsmasters-icon-angle-right").addClass("cmsmasters-icon-angle-up active").closest("li").find("ul.sub-menu").eq(0).show(),!1}),i.v.respButton.on("click",function(){i.v.trigger&&s(this).hasClass("active")&&i.resetNav()})},detachEvents:function(){i.v.subLinkToggle.off("click")}},i.init()}}(jQuery);
