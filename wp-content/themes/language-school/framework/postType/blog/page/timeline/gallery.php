		...
		?>
				...
				<?php 
					foreach ($cmsmasters_post_images as $cmsmasters_post_image) {
						...
						echo '<div>' . 
							'<figure>' . 
								wp_get_attachment_image($cmsmasters_post_image, 'cmsmasters-post-thumbnail', false, array( 
									'class' => 	'full-width', 
			...
			<?php 
				...
				language_school_thumb(get_the_ID(), 'cmsmasters-post-thumbnail', false, 'img_' . get_the_ID(), true, true, true, true, $cmsmasters_post_images[0]);
			} elseif (has_post_thumbnail()) {
				language_school_thumb(get_the_ID(), 'cmsmasters-post-thumbnail', false, 'img_' . get_the_ID(), true, true, true, true, false);
			}
		}
