...
function get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_portfolio_project_details_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_portfolio_project_details_title'] : esc_html__('Project details', 'language-school');
