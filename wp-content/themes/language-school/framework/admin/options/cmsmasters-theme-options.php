...
if (CMSMASTERS_LEARNPRESS) {
	require_once(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-lpr-course.php');
	
	require_once(CMSMASTERS_OPTIONS . '/cmsmasters-theme-options-lpr-quiz.php');
}
...
function language_school_admin_enqueue_scripts($hook) {
	if ( 
		...
		wp_localize_script('cmsmasters_theme_options_js', 'cmsmasters_options', array( 
			...
			'want_remove' => 		esc_html__('Do you realy want to remove this item?', 'language-school'), 
			'remove' => 			esc_attr__('Remove', 'language-school'), 
			'find' => 				esc_attr__('Find icons', 'language-school'), 
			'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'language-school') 
		));
