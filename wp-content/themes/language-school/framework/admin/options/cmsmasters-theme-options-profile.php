...
function get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title']) && $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] !== '') ? $cmsmasters_option[CMSMASTERS_SHORTNAME . '_profile_post_details_title'] : esc_html__('Profile details', 'language-school');
