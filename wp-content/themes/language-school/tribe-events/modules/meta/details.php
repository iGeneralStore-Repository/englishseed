...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<div class="cmsmasters_event_meta_info">
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php echo esc_html( 'Cost:', 'the-events-calendar' ) ?></span>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<div class="cmsmasters_event_meta_info_item">
				<span class="cmsmasters_event_meta_info_item_title"><?php echo esc_html( 'Website:', 'the-events-calendar' ) ?></span>
